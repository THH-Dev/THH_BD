...
public class CustomerChecked extends Fragment implements Searchable {
    ...
    public interface OnItemClickListener {
        void onItemClickedChecked(Customer customer);
    }

    public CustomerChecked() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (customerList != null) {
            customerAdapter = new CustomerAdapter(customerList, requireActivity(), new CustomerAdapter.OnItemClickListener() {
                ...
                public void onItemClick(Customer customer, View view) {
                    if (listener != null) {
                        listener.onItemClickedChecked(customer);
                        getData();
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof CustomerChecked.OnItemClickListener) {
            listener = (CustomerChecked.OnItemClickListener) context;
        } else {
